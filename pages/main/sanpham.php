...
<?php
    $sql_chitiet = "SELECT * FROM tbl_sanpham,danhmucsp WHERE tbl_sanpham.id_danhmuc = danhmucsp.id_danhmuc 
...
<div class="tabs">
  <ul id="tabs-nav">
    <li><a href="#tab1">Mô tả chi tiết</a></li>
    <li><a href="#tab2">Chất liệu</a></li>
